 ...
 * functions.
 */
extern __softfp int _ilogb(double);
extern __softfp int _ilogbf(float);
extern __softfp double _logb(double);
extern __softfp float _logbf(float);
extern __softfp double __ARM_scalbn(double, int);
extern __softfp float __ARM_scalbnf(float, int);
extern __softfp double _nextafter(double, double);
extern __softfp float _nextafterf(float, float);
extern __softfp float _nexttowardf(float, double);
