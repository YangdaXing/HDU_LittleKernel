...
/*
 * RCS $Revision: 180254 $
 * Checkin $Date: 2013-06-03 17:00:28 +0100 (Mon, 03 Jun 2013) $
...
extern _ARMABI long int atol(const char * /*nptr*/) __attribute__((__nonnull__(1)));
    ...
    */
#if !defined(__STRICT_ANSI__) || __USE_C99_STDLIB
extern _ARMABI __int64 atoll(const char * /*nptr*/) __attribute__((__nonnull__(1)));
   /*
...
extern _ARMABI __int64 strtoll(const char * __restrict /*nptr*/,
                               char ** __restrict /*endptr*/, int /*base*/) __attribute__((__nonnull__(1)));
   /*
    ...
    * macro ERANGE is stored in errno.
    */
extern _ARMABI unsigned __int64 strtoull(const char * __restrict /*nptr*/,
                                         char ** __restrict /*endptr*/, int /*base*/) __attribute__((__nonnull__(1)));
   /*
...
#if !defined(__STRICT_ANSI__) || __USE_C99_STDLIB
extern _ARMABI_PURE __int64 llabs(__int64 /*j*/);
   /*
    * computes the absolute value of a __int64 integer j. If the
    * result cannot be represented, the behaviour is undefined.
    * Returns: the absolute value.
    */
#ifdef __cplusplus
   extern "C++" inline _ARMABI_PURE __int64 abs(__int64 x) { return llabs(x); }
#endif

extern _ARMABI_PURE lldiv_t lldiv(__int64 /*numer*/, __int64 /*denom*/);
   /*
    * computes the quotient and remainder of the division of the numerator
    * numer by the denominator denom. If the division is inexact, the sign of
    * the resulting quotient is that of the algebraic quotient, and the
    ...
    */
#ifdef __cplusplus
   extern "C++" inline _ARMABI_PURE lldiv_t div(__int64 __numer, __int64 __denom) {
